...
// NewInt creates a new Int32
func NewInt(i int32, valid bool) Int32 {
	return Int32{
...
// IntFrom creates a new Int32 that will be null if zero.
func IntFrom(i int32) Int32 {
	return NewInt(i, i != 0)
}

// IntFromPtr creates a new Int32 that be null if i is nil.
func IntFromPtr(i *int32) Int32 {
	if i == nil {
